        ...
        **kwargs
        ...
        try:
            ...
            if response.parsed is None:
                logger.warning("Structured output parsing returned None, attempting fallback")
                return self._fallback_parse(response.choices[0].message.content, response_format)
