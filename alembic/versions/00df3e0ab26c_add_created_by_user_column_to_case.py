...
def upgrade() -> None:
    ...
    op.add_column('cases', sa.Column('created_by_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    ...
    # op.create_unique_constraint(None, 'form_templates', ['qdrant_id'])
...
def downgrade() -> None:
    ...
    op.alter_column('notes', 'note_type',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.drop_constraint(None, 'form_templates', type_='unique')
