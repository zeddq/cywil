...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run Celery worker for AI Paralegal POC")
    parser.add_argument(
        "--queues",
    ...
    parser.add_argument(
        "--flower",
        action="store_true",
        help="Also run Flower monitoring on port 5555"
    )
    ...
    try:
        ...
        if args.beat:
            ...
            beat_cmd = ["celery", "-A", "app.worker.celery_app", "beat", f"--loglevel={args.loglevel}"]
