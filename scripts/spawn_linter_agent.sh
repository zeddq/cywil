...
7. If a required module is missing and you're certain it's not leftover code from refactoring:
   - Install the module using pip
   - Add it to both requirements.txt and requirements-test.txt (pinned to installed version)
